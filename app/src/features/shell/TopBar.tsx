...
export function TopBar() {
  ...
  return (
    <header className="topbar">
      ...
      {/* Two groups, so the row can only break between them.
          Ungrouped, these eight items wrapped wherever they happened to run
          out of width: three rows on a tablet with "Data & limits" stranded by
          itself at the right edge. The split is what they are — what the plan
          is about, then what you can do to it — so a break there reads as a
