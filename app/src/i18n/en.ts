...
export const EN_MESSAGES = {
  ...
  "map.freeway": "I-5",
  "chart.scrollRegion": "Forecast chart, scrollable sideways",
  "forecast.scorecardScroll": "Model scorecard table, scrollable sideways",
  "map.scrollRegion": "Map, scrollable sideways",
