...
export const ES_MESSAGES: Catalogue = {
  ...
  "map.freeway": "I-5",
  "chart.scrollRegion": "Gráfico de pronóstico, desplazable horizontalmente",
  "forecast.scorecardScroll": "Tabla de resultados del modelo, desplazable horizontalmente",
  "map.scrollRegion": "Mapa, desplazable horizontalmente",
