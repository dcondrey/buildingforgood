...
The full analytical narrative, design rationale, data inventory, and source
audit behind Still Here SD. The [README](../../README.md) is the short front
door; this document carries the depth.
...
intentionally git-ignored; see [`data/raw/README.md`](../../data/raw/README.md).
The committed deployment-safe demo artifact is enough to run the interface.
...
## Responsible-data principles as product behavior
